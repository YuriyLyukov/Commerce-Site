  ...
  <section class="text-gray-600 body-font">
    <div class="container px-5 py-24 mx-auto">
      <div class=" text-center w-full mb-20">
        <button
            class="inline-block px-6 mb-14 py-2 text-xl font-medium leading-6 text-center text-black uppercase transition bg-gray-100 rounded shadow ripple hover:shadow-lg hover:bg-gray-200 focus:outline-none"
        >
          Reviews
        </button>
        <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900">What our customers say..</h1>
      </div>
